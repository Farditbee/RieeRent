            ...
            <div class="col-lg-12 col-12">
                <nav aria-label="Page navigation example">
                    <ul class="pagination justify-content-center mb-0">
                        <li class="page-item">
                            <a class="page-link" href="{{ route('dataaksesoris2') }}" aria-label="Previous">
                        ...
                        <li class="page-item">
                            <a class="page-link active" href="{{ route('dataaksesoris3') }}" @class(["page-link", "active"=> request()->routeIs('dataaksesoris3*') ])>3</a>
                        </li>
                ...
                <div class="col-lg-8 col-12 mt-3 mx-auto">
                    <div class="custom-block custom-block-topics-listing bg-white shadow-lg mb-5">
                        <div class="d-flex">
                           ...
                           <div id="portfolio">
                            <div class="portfolio-item">
                                <a href="{{ asset('skydash') }}/images/acc4.jpg" class="portfolio-popup custom-block-image img-fluid">
                                    <img src="{{ asset('skydash') }}/images/acc4.jpg" class="custom-block-image img-fluid" alt="">
                        ...
                        <!--portfolio-->
                            <div class="custom-block-topics-listing-info d-flex">
                                <div>
                                    <h5 class="mb-2">&nbsp;</h5>
                                    <h5 class="mb-2">Headband Konoha &nbsp;<sup class="text-danger">NRTA-02</sup></h5>
                                    <h6 class="mb-1">Rp. 8.000,- &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                        &nbsp;&nbsp;&nbsp;
                                        &nbsp;&nbsp;&nbsp;
                                        &nbsp;&nbsp;&nbsp;
                                        &nbsp;&nbsp;&nbsp;
                    ...
                    <div class="custom-block custom-block-topics-listing bg-white shadow-lg mb-5">
                        <div class="d-flex">
                            ...
                            <div id="portfolio">
                                <div class="portfolio-item">
                                    <a href="{{ asset('skydash') }}/images/acc3.jpg" class="portfolio-popup custom-block-image img-fluid">
                                        <img src="{{ asset('skydash') }}/images/acc3.jpg" class="custom-block-image img-fluid" alt="">
                                        <div class="portfolio-overlay">
                                            <div class="portfolio-info">
                                            </div>
                                        </div>
                            ...
                            <div class="custom-block-topics-listing-info d-flex">
                                <div>
                                    <h5 class="mb-2">&nbsp;</h5>
                                    <h5 class="mb-2">Stocking &nbsp;<sup class="text-danger">ADD-01</sup></h5>
                    ...
                    <div class="custom-block custom-block-topics-listing bg-white shadow-lg mb-5">
                        <div class="d-flex">
                            ...
                            <div id="portfolio">
                                <div class="portfolio-item">
                                    <a href="{{ asset('skydash') }}/images/acc5.jpg" class="portfolio-popup custom-block-image img-fluid">
                                        <img src="{{ asset('skydash') }}/images/acc5.jpg" class="custom-block-image img-fluid" alt="">
                                        <div class="portfolio-overlay">
                                            <div class="portfolio-info">
                                            </div>
                                        </div>
                            ...
                            <div class="custom-block-topics-listing-info d-flex">
                                <div>
                                    <h5 class="mb-2">&nbsp;</h5>
                                    <h5 class="mb-2">Hokage Coat &nbsp;<sup class="text-danger">NRTA-03</sup></h5>
